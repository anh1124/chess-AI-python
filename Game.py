import pygame  #giao diện pygame
#
#
import Rule, AI #Engine : quản lý logic chess,AI: tạo nước đi cho AI
import sys  
from multiprocessing import Process, Queue

BOARD_WIDTH = BOARD_HEIGHT = 512#kích thước bàn cờ
...
def main():
    """
    xử lỹ cập nhật đồ họa
    """
    pygame.init() #Khởi tạo pygame
    screen = pygame.display.set_mode((BOARD_WIDTH + MOVE_LOG_PANEL_WIDTH, BOARD_HEIGHT)) # tạo cửa sổ trò chơi
    clock = pygame.time.Clock() # > kiểm soát tốc độ khung hình và thời gian
    ...
    #set player đi trắng hay đen
    player_one = True  #nếu player màu trắng thì điều này sẽ là Đúng, nếu không thì là Sai
    player_two = False  
            ...
            # mouse handler
                ...
                if not game_over:
                    ...
                    if len(player_clicks) == 2 and human_turn:  # after 2nd click
                        move = Rule.Move(player_clicks[0], player_clicks[1], game_state.board)
